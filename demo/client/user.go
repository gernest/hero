...
func (u *User) Email() string {
	return u.Data().Get(userParams.Email).Str()
}

// Name gets the users full name.
func (u *User) Name() string {
	return u.Data().Get(userParams.Name).Str()

}

// Nickname gets the users nickname or username.
func (u *User) Nickname() string {
	return u.Data().Get(userParams.NickName).Str()

}

// AvatarURL gets the URL of an image representing the user.
func (u *User) AvatarURL() string {
	return u.Data().Get(userParams.Avatar).Str()
}
